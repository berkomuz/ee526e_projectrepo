  ...
  foreach var2 $&vg_vec
    ...
    foreach var3 $&vd_vec
      ...
      foreach var4 $&vb_vec
        alter vsb $var4
	run 
	wrdata techsweep_sg13_lv_nmos.txt 
*wrdata noise1.all
	destroy all
	set appendwrite
...
C {devices/vsource.sym} 520 -160 0 0 {name=vg value=\{vg\} AC 1}
C {devices/vsource.sym} 780 -240 0 0 {name=vd value=\{vd\}}
...
descr="rg="}
C {devices/vsource.sym} 720 -160 2 1 {name=vsb value=\{vsb\}}
